	...
	jQuery.noConflict();//it Works :D harus semua file pake jquery
        ...
        jQuery(function(){
            jQuery('.auto_search_diagnosa').autocomplete({
                ...
                serviceUrl: site+'/IrjPelayanan/data_diagnosa',
                // fungsi ini akan dijalankan ketika user memilih salah satu hasil request
                onSelect: function (suggestion) {
                    $('#id_diagnosa').val(''+suggestion.id);
                    $('#diagnosa').val(''+suggestion.sub_diagnosa);
                }
            });
        });
		jQuery(function(){
            jQuery('.auto_search_operator').autocomplete({
                // serviceUrl berisi URL ke controller/fungsi yang menangani request kita
                serviceUrl: site+'/IrjPelayanan/data_operator',
                // fungsi ini akan dijalankan ketika user memilih salah satu hasil request
                onSelect: function (suggestion) {
...
function data_edit(param0,param1,param2,param3,param4,param5,param6,param7){
	document.getElementById("id_diagnosa2").value = param0;
	document.getElementById("diagnosa2").value = param1;
	document.getElementById("id_dokter2").value = param2;
	document.getElementById("nm_dokter2").value = param3;
	document.getElementById("tindakan2").value = param4;
	document.getElementById("klasifikasi_diagnos2").value = param5;
	document.getElementById("kasus2").value = param6;
	document.getElementById("id_diagnosa_pasien2").value = param7;
}
	jQuery(function(){
            jQuery('.auto_search_diagnosa2').autocomplete({
                ...
                // fungsi ini akan dijalankan ketika user memilih salah satu hasil request
                onSelect: function (suggestion) {
                    $('#id_diagnosa2').val(''+suggestion.id);
                    $('#diagnosa2').val(''+suggestion.sub_diagnosa);
                }
            });
        });
		jQuery(function(){
					...
					<div class="panel panel-default">
						<div class="panel-heading" align="center">
							<ul class="nav nav-pills nav-justified">
							  <li role="presentation"><a href="<?php echo site_url('IrjPelayanan/pelayanan_pasien/'.$id_poli.'/'.$no_register);?>">Tindakan</a></li>
							  <li role="presentation" class="active"><a href="<?php echo site_url('IrjPelayanan/pelayanan_diagnosa/'.$id_poli.'/'.$no_register);?>">Diagnosa</a></li>
							  <li role="presentation"><a href="<?php echo site_url('IrjPelayanan/pelayanan_resep/'.$id_poli.'/'.$no_register);?>">Resep</a></li>
							</ul>
						</div>
						<div class="panel-body">
							<!-- form -->
							<div class="well" style="background-color:#BAD8FF;">
							<?php echo form_open('IrjPelayanan/insert_pelayanan_diagnosa'); ?>
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="lbl_diagnosa">Diagnosa</p>
										<div class="col-sm-8">
											<div class="form-inline">
												<input type="search" size="50" class="auto_search_diagnosa form-control" placeholder="" id="diagnosa" name="diagnosa">
								...
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="lbl_klasifikasi_diagnos">Klasifikasi</p>
									<div class="col-sm-8">
										<input type="text" class="form-control" value="" name="klasifikasi_diagnos">
									</div>
								</div>
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="kasus">Kasus</p>
									<div class="col-sm-4">
								...
								?>
									<tr>
										...
										<td>
											...
											<?php echo '<a data-toggle="modal" data-id="" title="Add this item" class="open-form-edit btn btn-warning btn-xs" href="#form-edit" onclick="data_edit(\''.$row->id_diagnosa.'\',\''.$row->diagnosa.'\',\''.$row->id_dokter.'\',\''.$row->nm_dokter.'\',\''.$row->tindakan.'\',\''.$row->klasifikasi_diagnos.'\',\''.$row->kasus.'\',\''.$row->id_diagnosa_pasien.'\')">Edit</a>';?>
										</td>
									</tr>
								<?php
									}
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php echo form_open('IrjPelayanan/update_diagnosa');?>
      <div class="modal-body">
		  <div style="display:block;overflow:auto;">
								...
								<p class="col-sm-2 form-control-label" id="lbl_diagnosa">Diagnosa</p>
										<div class="col-sm-8">
											<div class="form-inline">
												<input type="search" style="width:450px" class="auto_search_diagnosa2 form-control" placeholder="" id="diagnosa2" name="diagnosa2" required>
