					...
					<div class="panel panel-default">
						<div class="panel-heading" align="center">
							<ul class="nav nav-pills nav-justified">
							  ...
							  <li role="presentation" class="active"><a href="<?php echo site_url('irj/rjcpelayanan/pelayanan_resep/'.$id_poli.'/'.$no_register);?>">Resep</a></li>
						...
						<br/>
							...
							<?php echo form_open('irj/rjcpelayanan/insert_resep'); ?>
								...
								<div class="form-group row">
									<p class="col-sm-2 form-control-label" id="resep">Resep</p>
									<div class="col-sm-10">
