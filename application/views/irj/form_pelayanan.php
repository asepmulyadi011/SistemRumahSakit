	...
	var site = "<?php echo site_url();?>";
        jQuery(function(){
            jQuery('.auto_search_tindakan').autocomplete({
                ...
                serviceUrl: site+'/IrjPelayanan/data_tindakan',
					...
					<div class="panel panel-default">
						<div class="panel-heading" align="center">
							<ul class="nav nav-pills nav-justified">
							  <li role="presentation" class="active"><a href="<?php echo site_url('IrjPelayanan/pelayanan_pasien/'.$id_poli.'/'.$no_register);?>">Tindakan</a></li>
							  <li role="presentation"><a href="<?php echo site_url('IrjPelayanan/pelayanan_diagnosa/'.$id_poli.'/'.$no_register);?>">Diagnosa</a></li>
						...
						<br/>
							...
							<?php echo form_open('IrjPelayanan/insert_pelayanan_poli'); ?>
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="tindakan">Tindakan</p>
										<div class="col-sm-8">
											<div class="form-inline">
												<input type="search" size="50" class="auto_search_tindakan form-control" placeholder="" id="nmtindakan" name="nmtindakan" required>
								...
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="lbl_biaya_poli">Biaya Poli</p>
									<div class="col-sm-8">
										<input type="number" min=0 class="form-control" value="" name="biaya_poli">
									</div>
								</div>
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="lbl_qtyind">Qtyind</p>
									<div class="col-sm-8">
										<input type="text" class="form-control" value="1" name="qtyind">
									</div>
								</div>
								<div class="form-group row">
									<p class="col-sm-4 form-control-label" id="lbl_dijamin">Dijamin</p>
									<div class="col-sm-8">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php echo form_open('IrjPelayanan/update_tindakan');?>
      <div class="modal-body">
		  <div style="display:block;overflow:auto;">
								...
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" value="1" name="qtyind2" id="qtyind2">
									</div>
								</div>
								<div class="form-group row">
