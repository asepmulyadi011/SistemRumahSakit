					...
					<div class="panel panel-default">
						<div class="panel-heading" align="center">
							<ul class="nav nav-pills nav-justified">
							  ...
							  <li role="presentation" class="active"><a href="<?php echo site_url('IrjPelayanan/pelayanan_resep/'.$id_poli.'/'.$no_register);?>">Resep</a></li>
							</ul>
						</div>
						<div class="panel-body">
							<div class="well" style="background-color:#BAD8FF;">
							<?php echo form_open('IrjPelayanan/insert_pelayanan_resep'); ?>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php echo form_open('IrjPelayanan/update_resep');?>
