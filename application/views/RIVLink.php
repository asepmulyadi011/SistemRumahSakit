...
<html>
	<head>
		...
		<!-- Ionicons -->
		<link rel="stylesheet" href="<?php echo base_url('plugin/plugins/ionicons/ionicons.min.css'); ?>">
		<!-- DataTables -->
		...
		<!-- Morris chart -->
		<link rel="stylesheet" href="<?php echo base_url('plugin/plugins/morris/morris.css'); ?>">
		<!-- jvectormap -->
		<link rel="stylesheet" href="<?php echo base_url('plugin/plugins/jvectormap/jquery-jvectormap-1.2.2.css'); ?>">
		<!-- Date Picker -->
		<link rel="stylesheet" href="<?php echo base_url('plugin/plugins/datepicker/datepicker3.css'); ?>">
		<!-- Daterange picker -->
		<link rel="stylesheet" href="<?php echo base_url('plugin/plugins/daterangepicker/daterangepicker-bs3.css'); ?>">
		<!-- bootstrap wysihtml5 - text editor -->
		<link rel="stylesheet" href="<?php echo base_url('plugin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css'); ?>">
		<!-- Custom -->
	...
	<body class="hold-transition skin-blue sidebar-mini">
		...
		<!-- jQuery UI 1.11.4 -->
		<script src="<?php echo base_url('plugin/plugins/jQueryUI/jquery-ui.min.js'); ?>"></script>
		...
		<!-- Morris.js charts -->
		<script src="<?php echo base_url('plugin/plugins/morris/raphael-min.js'); ?>"></script>
		<script src="<?php echo base_url('plugin/plugins/morris/morris.min.js'); ?>"></script>
		<!-- Sparkline -->
		<script src="<?php echo base_url('plugin/plugins/sparkline/jquery.sparkline.min.js'); ?>"></script>
		<!-- jvectormap -->
		<script src="<?php echo base_url('plugin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'); ?>"></script>
		<script src="<?php echo base_url('plugin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'); ?>"></script>
		<!-- jQuery Knob Chart -->
		<script src="<?php echo base_url('plugin/plugins/knob/jquery.knob.js'); ?>"></script>
		<!-- daterangepicker -->
		...
		<!-- Bootstrap WYSIHTML5 -->
		<script src="<?php echo base_url('plugin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js'); ?>"></script>
		<!-- Slimscroll -->
