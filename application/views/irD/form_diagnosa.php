	...
	jQuery.noConflict();//it Works :D harus semua file pake jquery
        ...
        jQuery(function(){
            jQuery('.auto_search_diagnosa').autocomplete({
                ...
                serviceUrl: site+'/IRD/IrDPelayanan/data_diagnosa',
					...
					<div class="panel panel-default">
						<div class="panel-heading" align="center">
							<ul class="nav nav-pills nav-justified">
							  ...
							  <li role="presentation" class="active"><a href="<?php echo site_url('IRD/IrDPelayanan/pelayanan_diagnosa/'.$no_register);?>">Diagnosa</a></li>
							  <li role="presentation"><a href="<?php echo site_url('IRD/IrDPelayanan/pelayanan_resep/'.$no_register);?>">Resep</a></li>
							</ul>
						</div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php echo form_open('IRD/IrDPelayanan/update_diagnosa');?>
