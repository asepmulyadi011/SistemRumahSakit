	...
	var site = "<?php echo site_url();?>";
        jQuery(function(){
            jQuery('.auto_search_tindakan').autocomplete({
                ...
                serviceUrl: site+'/IRD/IrDPelayanan/data_tindakan',
					...
					<div class="panel panel-default">
						<div class="panel-heading" align="center">
							<ul class="nav nav-pills nav-justified">
							  <li role="presentation" class="active"><a href="<?php echo site_url('IRD/IrDPelayanan/pelayanan_pasien/'.$no_register);?>">Tindakan</a></li>
						...
						<br/>
							...
							<?php echo form_open('IRD/IrDPelayanan/insert_pelayanan_poli'); ?>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php echo form_open('IRD/IrDPelayanan/update_tindakan');?>
