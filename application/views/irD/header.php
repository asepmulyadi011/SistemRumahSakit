...
?>
	...
	<script type="text/javascript" src="<?php echo base_url('asset/jquery/jquery-1.8.2.min.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('asset/jquery/jquery.autocomplete.js');?>"></script>
