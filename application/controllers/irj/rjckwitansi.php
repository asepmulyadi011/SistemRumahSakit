...
class rjckwitansi extends CI_Controller {
	...
	{	
		$data['pasien_daftar']=$this->rjmkwitansi->get_pasien_kwitansi()->result();
	...
	{	
		...
		$data['data_pasien']=$this->rjmkwitansi->getdata_pasien($no_register)->result();
