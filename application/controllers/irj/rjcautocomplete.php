...
class rjcautocomplete extends CI_Controller {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////registrasi
	...
	public function data_pasien_by_nokartu(){
			$keyword = $this->uri->segment(4);
			$data = $this->db->from('data_pasien')->like('no_kartu',$keyword)->get()->result();	
	...
	public function data_pasien_by_noidentitas(){
			$keyword = $this->uri->segment(4);
			$data = $this->db->from('data_pasien')->like('no_identitas',$keyword)->get()->result();	
