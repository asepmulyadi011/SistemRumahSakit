...
class IrjRegistrasi extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('irj/form_daftar',$data);
	}
	public function search_pasien()
	{
		$data['no_medrec']=$this->input->post('no_medrec');
		redirect('IrjRegistrasi/index2/'.$data['no_medrec']);
	}
	public function index2($no_cm='')
	{
		...
		$this->load->view('irj/form_daftar2',$data);
		}
	}
	...
	{	
		...
		redirect('IrjRegistrasi/index2/'.$no_medrec);
	}
	...
	public function data_pasien(){
			...
			// cari di database
			$data = $this->db->from('pasien_irj')->like('no_medrec',$keyword)->get()->result();	
	...
	{	
		// $data['poliklinik']=$this->ModelRegistrasi->get_poli()->result();//untuk nav
		$this->load->view('irj/kwitansi',$data);
	}
	public function list_poli()
	{	
		$data['poliklinik']=$this->ModelRegistrasi->get_poli()->result();//untuk nav
		$this->load->view('irj/list_poli',$data);
	}
