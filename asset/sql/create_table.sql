...
create table data_pasien(
	...
	jenis_identitas varchar(10),--KTP/SIM/PASPOR/KTM/lain-lain
	no_identitas varchar(20),
	jenis_kartu varchar(10),--BPJS,ASKES,dll
	no_kartu varchar(20),
	...
	kartusdhdicetak char default 0,--1 sudah 0 belum
	tglcetakkartu date,
	foto varchar(200),
...
create table daftar_ulang(
	...
	jns_kunj varchar(10),--baru/lama
	ublnrj int default 0,
	uharirj int default 0,
	umurrj int default 0,
	cara_kunj varchar(50),--tabel master cara_kunjungan
	asal_rujukan varchar(100),
	no_rujukan varchar(20),
	kelas_pasien varchar(10),
	cara_bayar varchar(50),--tabel master cara_bayar
	id_poli varchar(5),--table master poliklinik
	kd_ruang varchar(10),--table master poliklinik
	biayadaftar int default 0,
	nama_penjamin varchar(100),
	hubungan varchar(100),
	vtot int default 0,
	status char default 0,--0 belum, 1 selesai, 2 batal
	tgl_pulang date,
	ket_pulang varchar(50),--keterangan dirujuk dll
	no_sep varchar(20),
	xupdate timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	xuser varchar(100),
	xterminal varchar(100),
...
create table pelayanan_poli(
	...
	no_register varchar(10),
	tgl_kunjungan timestamp DEFAULT CURRENT_TIMESTAMP,
	idtindakan varchar(10),--table master jenis_tindakan
	nmtindakan varchar(100),--table master jenis_tindakan
	id_dokter varchar(10),--tabel master operator
	nm_dokter varchar(100),--tabel master operator
	id_poli varchar(5),--tabel master poliklinik
...
create table diagnosa_pasien(
	...
	id_dokter varchar(10),--tabel master operator
	nm_dokter varchar(100),--tabel master operator
	id_diagnosa varchar(10),--table master icd10->id
	diagnosa varchar(255),--table master icd10->sub_diagnosa
	id_poli varchar(5),--table master poliklinik
